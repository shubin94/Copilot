...
import { Search, MoreHorizontal, Ban, Plus, Trash2 } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold capitalize" data-testid="text-plan">
                      {(selectedDetective as any).subscriptionPackage?.displayName || (selectedDetective as any).subscriptionPackage?.name || 'Free'}
                    </p>
                  </div>
                  <div>
